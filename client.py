...
class ClientWindow:
    ...
    def connection_setup(self):
        ...
        self.uic.button_connect.setIcon(QIcon("image\\icon_on.png"))
        self.uic.button_disconnect.clicked.connect(self.disconnect)
        self.uic.button_disconnect.setIcon(QIcon("image\\icon_off.png"))
    ...
    def control_input_setup(self):
        ...
        self.uic.button_lock_input.setIcon(QIcon("image\\icon_lock.png"))
        self.uic.button_unlock_input.clicked.connect(self.unlock_input)
        self.uic.button_unlock_input.setIcon(QIcon("image\\icon_unlock.png"))
        self.uic.button_start_keylogger.clicked.connect(self.start_keylogger)
        self.uic.button_start_keylogger.setIcon(QIcon("image\\icon_on.png"))
        self.uic.button_stop_keylogger.clicked.connect(self.stop_keylogger)
        self.uic.button_stop_keylogger.setIcon(QIcon("image\\icon_off.png"))
        self.uic.button_clear_keylog.clicked.connect(self.clear_keylog)
        self.uic.button_clear_keylog.setIcon(QIcon("image\\icon_delete.png"))
        self.uic.button_save_keylog.clicked.connect(self.save_keylog)
        self.uic.button_save_keylog.setIcon(QIcon("image\\icon_save.png"))
        self.uic.button_browser_keylog.clicked.connect(self.browser_keylog)
        self.uic.button_browser_keylog.setIcon(QIcon("image\\icon_browser.png"))
    ...
    def control_input(self):
        ...
        self.uic.text_status_keylogger.setText("")
    def lock_input(self):
