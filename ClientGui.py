...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.text_directory_screen = QtWidgets.QLineEdit(self.widget_screen_stream)
        self.text_directory_screen.setEnabled(True)
        self.text_directory_screen.setGeometry(QtCore.QRect(110, 540, 631, 21))
        font = QtGui.QFont()
        font.setFamily("MS Shell Dlg 2")
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        self.text_directory_screen.setFont(font)
        self.text_directory_screen.setObjectName("text_directory_screen")
        self.button_screenshot = QtWidgets.QPushButton(self.widget_screen_stream)
        self.button_screenshot.setGeometry(QtCore.QRect(40, 450, 121, 31))
        font = QtGui.QFont()
        font.setFamily("MS Shell Dlg 2")
        font.setPointSize(10)
        font.setBold(False)
        ...
        self.button_screenshot.setIconSize(QtCore.QSize(20, 20))
        ...
        self.button_browser_screen.setGeometry(QtCore.QRect(40, 490, 121, 31))
        font = QtGui.QFont()
        font.setFamily("MS Shell Dlg 2")
        font.setPointSize(10)
        font.setBold(False)
        ...
        self.button_browser_screen.setIconSize(QtCore.QSize(20, 20))
        ...
        self.text_status_screen = QtWidgets.QLabel(self.widget_screen_stream)
        self.text_status_screen.setGeometry(QtCore.QRect(10, 410, 171, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.text_status_screen.setFont(font)
        self.text_status_screen.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.text_status_screen.setText("")
        self.text_status_screen.setAlignment(QtCore.Qt.AlignCenter)
        self.text_status_screen.setObjectName("text_status_screen")
        self.text_status_screen.raise_()
        self.label_7.raise_()
        self.label_screen.raise_()
        self.text_directory_screen.raise_()
        self.button_screenshot.raise_()
        self.label_14.raise_()
        self.button_browser_screen.raise_()
        self.text_filename_screen.raise_()
        ...
        self.button_lock_input.setGeometry(QtCore.QRect(50, 60, 141, 71))
        font = QtGui.QFont()
        font.setFamily("MS Shell Dlg 2")
        font.setPointSize(10)
        font.setBold(False)
        ...
        self.button_lock_input.setIconSize(QtCore.QSize(25, 25))
        ...
        self.button_start_keylogger.setGeometry(QtCore.QRect(50, 140, 141, 31))
        font = QtGui.QFont()
        font.setFamily("MS Shell Dlg 2")
        font.setPointSize(10)
        font.setBold(False)
        ...
        self.button_start_keylogger.setIconSize(QtCore.QSize(20, 20))
        ...
        self.button_stop_keylogger.setGeometry(QtCore.QRect(50, 180, 141, 31))
        font = QtGui.QFont()
        font.setFamily("MS Shell Dlg 2")
        font.setPointSize(10)
        font.setBold(False)
        ...
        self.button_stop_keylogger.setIconSize(QtCore.QSize(20, 20))
        ...
        self.button_save_keylog.setGeometry(QtCore.QRect(50, 440, 141, 31))
        font = QtGui.QFont()
        font.setFamily("MS Shell Dlg 2")
        font.setPointSize(10)
        font.setBold(False)
        ...
        self.button_unlock_input.setGeometry(QtCore.QRect(50, 60, 141, 71))
        font = QtGui.QFont()
        font.setFamily("MS Shell Dlg 2")
        font.setPointSize(10)
        font.setBold(False)
        ...
        self.button_unlock_input.setIconSize(QtCore.QSize(25, 25))
        self.button_unlock_input.setObjectName("button_unlock_input")
        self.text_directory_keylog = QtWidgets.QLineEdit(self.widget_control_input)
        self.text_directory_keylog.setEnabled(True)
        self.text_directory_keylog.setGeometry(QtCore.QRect(110, 530, 671, 21))
        font = QtGui.QFont()
        font.setFamily("MS Shell Dlg 2")
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        self.text_directory_keylog.setFont(font)
        self.text_directory_keylog.setObjectName("text_directory_keylog")
        self.button_browser_keylog = QtWidgets.QPushButton(self.widget_control_input)
        self.button_browser_keylog.setGeometry(QtCore.QRect(50, 480, 141, 31))
        font = QtGui.QFont()
        font.setFamily("MS Shell Dlg 2")
        font.setPointSize(10)
        font.setBold(False)
        ...
        self.button_browser_keylog.setIconSize(QtCore.QSize(20, 20))
        ...
        self.button_clear_keylog = QtWidgets.QPushButton(self.widget_control_input)
        self.button_clear_keylog.setGeometry(QtCore.QRect(50, 400, 141, 31))
        font = QtGui.QFont()
        font.setFamily("MS Shell Dlg 2")
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        self.button_clear_keylog.setFont(font)
        self.button_clear_keylog.setIconSize(QtCore.QSize(20, 20))
        self.button_clear_keylog.setObjectName("button_clear_keylog")
        self.keylog = QtWidgets.QLabel(self.widget_control_input)
        self.keylog.setGeometry(QtCore.QRect(220, 60, 821, 451))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.text_status_keylogger = QtWidgets.QLabel(self.widget_control_input)
        self.text_status_keylogger.setGeometry(QtCore.QRect(30, 360, 191, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.text_status_keylogger.setFont(font)
        self.text_status_keylogger.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.text_status_keylogger.setText("")
        self.text_status_keylogger.setAlignment(QtCore.Qt.AlignCenter)
        self.text_status_keylogger.setObjectName("text_status_keylogger")
        self.button_unlock_input.raise_()
        self.button_lock_input.raise_()
        self.text_status_keylogger.raise_()
        self.keylog.raise_()
        ...
        self.label_9.raise_()
        self.text_directory_keylog.raise_()
        self.button_browser_keylog.raise_()
        self.text_filename_keylog.raise_()
        self.button_clear_keylog.raise_()
        self.widget_power = QtWidgets.QWidget(self.centralwidget)
        self.widget_power.setGeometry(QtCore.QRect(160, 10, 1101, 601))
        self.widget_power.setAutoFillBackground(False)
        self.widget_power.setStyleSheet("background-color: rgb(221, 221, 221);")
        self.widget_power.setObjectName("widget_power")
        self.label_2 = QtWidgets.QLabel(self.widget_power)
        ...
        self.button_logout = QtWidgets.QPushButton(self.widget_power)
        self.button_logout.setGeometry(QtCore.QRect(460, 200, 161, 41))
        font = QtGui.QFont()
        font.setFamily("MS Shell Dlg 2")
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.button_logout.setIconSize(QtCore.QSize(27, 27))
        self.button_logout.setObjectName("button_logout")
        self.button_shutdown = QtWidgets.QPushButton(self.widget_power)
        self.button_shutdown.setGeometry(QtCore.QRect(460, 320, 161, 41))
        font = QtGui.QFont()
        font.setFamily("MS Shell Dlg 2")
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.button_shutdown.setIconSize(QtCore.QSize(27, 27))
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(120, 50, 851, 51))
        ...
        font = QtGui.QFont()
        font.setPointSize(10)
        self.buttonStartProcess.setFont(font)
        ...
        font = QtGui.QFont()
        font.setPointSize(10)
        self.buttonStartApp.setFont(font)
        ...
        self.icon_app_proc = QtWidgets.QLabel(self.widget_task_manager)
        self.icon_app_proc.setGeometry(QtCore.QRect(906, 51, 49, 49))
        self.icon_app_proc.setStyleSheet("border-image: url(:/image/image/icon_process.png);")
        self.icon_app_proc.setText("")
        self.icon_app_proc.setObjectName("icon_app_proc")
        ...
        self.label_5.setGeometry(QtCore.QRect(220, 20, 81, 31))
        font = QtGui.QFont()
        ...
        self.back.setGeometry(QtCore.QRect(20, 17, 41, 41))
        self.back.setStyleSheet("image: url(:/image/image/icon_back.png);")
        self.back.setText("")
        self.back.setObjectName("back")
        self.label_13 = QtWidgets.QLabel(self.frame_2)
        self.label_13.setGeometry(QtCore.QRect(220, 20, 91, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.button_connection.setIconSize(QtCore.QSize(27, 27))
        ...
        self.button_screen_stream.setIconSize(QtCore.QSize(27, 27))
        ...
        self.button_address.setIconSize(QtCore.QSize(27, 27))
        ...
        self.button_task_manager.setIconSize(QtCore.QSize(27, 27))
        ...
        self.button_file_explorer.setIconSize(QtCore.QSize(27, 27))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_14.setText(_translate("MainWindow", "Directory"))
        ...
        self.button_start_keylogger.setText(_translate("MainWindow", " Start keylogger"))
        self.button_stop_keylogger.setText(_translate("MainWindow", " Stop keylogger"))
        ...
        self.label_11.setText(_translate("MainWindow", "Directory"))
        self.label_12.setText(_translate("MainWindow", "Filename"))
        self.button_clear_keylog.setText(_translate("MainWindow", "    Clear      "))
